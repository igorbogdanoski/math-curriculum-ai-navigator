...
import type { ChartConfig } from './chartPreviewTypes';
...
export const BoxWhiskerChart: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
...
// ─── Stem-and-Leaf chart ─────────────────────────────────────────────────────
export const StemLeafChart: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
...
// ─── Dot Plot chart ──────────────────────────────────────────────────────────
export const DotPlotChart: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
  const values = data.rows
    .map(r => typeof r[1] === 'number' ? r[1] : parseFloat(String(r[1])))
    .filter(v => !isNaN(v));
...
export const HeatmapChart: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
...
export const BackToBackHistogram: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
...
// ─── Pictogram Chart ─────────────────────────────────────────────────────────
export const PictogramChart: React.FC<{ data: TableData; config: ChartConfig }> = ({ data, config }) => {
...
// ─── Histogram helper ───────────────────────────────────────────────────────
export function buildHistogram(values: number[], bins = 8): { name: string; count: number }[] {
