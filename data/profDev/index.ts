...
export interface ProfDevChapter {
  ...
  keyPoints: string[];
  icon: string; // emoji
  /** EU-OECD AI Literacy Framework (ailiteracyframework.org) competence codes this
   *  chapter addresses — E1-E7 Engage, C1-C4 Create, M1-M4 Manage, S1-S4 Shape. */
  competences?: string[];
}
...
export const CHAPTERS: ProfDevChapter[] = [
  ...
  // MANAGE & SHAPE — added to close EU-OECD AI Literacy Framework gaps
  {
    id: 'ch-18-when-to-use-ai',
    category: 'practice',
    order: 18,
    title: 'Кога (не) да користам AI',
    subtitle: 'Практична рамка за делегирање задачи',
    description:
      'Не секоја задача треба да ѝ се довери на AI, и не секоја задача треба да ја работите рачно. Способноста да ја разложите поголема задача на делови кои AI може добро да ги преземе и делови кои бараат ваша експертиза е клучна вештина — попрактична од самото знаење да "промптирате".',
    keyPoints: [
      'AI е добар за: прв нацрт, варијации на веќе познат формат, рутинска администрација',
      'Вие сте незаменливи за: педагошка проценка на конкретни ученици, финална одговорност за оценка, нијансирана комуникација',
      'Разложете задача: што бара локален контекст (вашето одделение, конкретен ученик) — тоа остава кај вас; што е генеричко и повторливо — тоа делегирајте',
      'Тест: ако AI грешеше во ова, дали ќе го забележам пред да го употребам? Ако не — не делегирајте го без дополнителна проверка',
    ],
    icon: '🧭',
    competences: ['M1', 'M3'],
  },
  {
    id: 'ch-19-choosing-tools',
    category: 'practice',
    order: 19,
    title: 'Избор на вистинска AI алатка',
    subtitle: 'Од листа на алатки до одлука за конкретна задача',
    description:
      'Оваа академија веќе содржи директориум од 47 AI алатки организирани по категории. Овој дел е водич за одлучување — како од таа листа да изберете 1-2 алатки за конкретна задача наместо да пробувате сè.',
    keyPoints: [
      'Прво прашање: текст, слика, видео или пресметка? Категоријата на задачата го стеснува изборот пред да пробате алатка',
      'Второ прашање: колку пати ќе го правам ова? Еднократна задача → општа алатка (ChatGPT/Gemini); повторлива задача → специјализирана алатка (Quizizz AI за квизови, Diffit за диференцијација)',
      'Трето прашање: цена и приватност — дали алатката бара ученички податоци? Ако да, проверете GDPR-усогласеност пред употреба (види МК-контекст поглавјето)',
      'Не менувајте алатка секоја недела — конзистентноста во една добра алатка носи подобри резултати од постојано пробување нови',
    ],
    icon: '🧰',
    competences: ['M2'],
  },
  {
    ...
    category: 'reference',
    order: 20,
    title: 'Влијание на AI: животна средина и општество',
    subtitle: 'Она што остава зад екранот',
    description:
      'Секое AI барање троши реална енергија и вода за ладење на серверите, а секоја препорака што ја добивате (или ја дава AI на вашите ученици) е обликувана од алгоритам чија цел не е секогаш вашата корист. Информираната употреба на AI бара свесност за двете.',
    keyPoints: [
      'Еден подолг AI разговор троши енергија споредлива со неколку минути стриминг видео — не е нула, но не е ниту причина да се одбегнува употребата, туку да се користи намерно',
      'Препорачувачки системи (YouTube, TikTok) не оптимизираат за учење — оптимизираат за времето поминато на апликацијата. Тоа може да го стесни, а не прошири, перспективата на ученикот',
      'Кога AI ви препорачува "следна активност" или "следен ресурс", прашајте: дали ова навистина е најрелевантно за целта, или е само она што системот проценил дека ќе ме задржи подолго?',
      'Практичен совет: користете AI намерно за конкретна задача, не оставајте препорачувачки алгоритми да ви го обликуваат текот на часот',
    ],
    icon: '🌱',
    competences: ['E4', 'E5'],
  },
  {
    id: 'ch-21-bias-fairness',
    category: 'reference',
    order: 21,
    title: 'AI пристрасност и правичност',
    subtitle: 'Кога "просечниот" одговор не е фер за секој ученик',
    description:
      'AI моделите се тренирани на огромни количини текст кои ги носат пристрасностите на своите извори — јазични, културни, родови. Во образование ова има директни последици: генерирани примери, имиња во текстуални задачи, дури и очекувања за "типичен" ученик можат тивко да ги фаворизираат едни ученици над други.',
    keyPoints: [
      'Пристрасноста не е "бag" што ќе се поправи — таа е структурна карактеристика на тренирачките податоци, секогаш присутна во некаква форма',
      'Во пракса: проверете дали AI-генерираните текстуални задачи користат разновидни имиња и контексти, не само еден културен образец',
      'Родова пристрасност: AI понекогаш доделува професии/улоги по стереотипен образец во примери — прегледајте пред да ги употребите со класот',
      'Правичноста е ваша одговорност, не на алатката: AI дава прв нацрт, вие правите финална проверка за инклузивност',
    ],
    icon: '⚖️',
    competences: ['E6'],
  },
  {
    id: 'ch-22-evaluating-outputs',
    category: 'practice',
    order: 22,
    title: 'Проценка на AI резултати',
    subtitle: 'Едноставна рамка пред да го употребите она што AI го создал',
    description:
      'AI генерираните планови за час, квизови и материјали (вклучително и оние што ги создавате директно во оваа апликација) заслужуваат брза, систематска проверка пред употреба во училница — не интуитивно "изгледа добро", туку конкретни критериуми.',
    keyPoints: [
      'Точност: дали фактите, формулите и решенијата се точни? (Верификувајте секоја математичка тврдба — AI халуцинира најчесто токму кај пресметки)',
      'Усогласеност: дали одговара на одделението, темата и целите на часот кои сте ги барале?',
      'Комплетност: дали недостасува чекор, диференцијација или контекст што вие би го додале?',
      'Брз тест со 3 прашања пред употреба: Точно ли е? За моето одделение ли е? Што би променил јас?',
    ],
    icon: '🔎',
    competences: ['S2'],
  },
  {
    id: 'ch-23-multimodal-creation',
    category: 'practice',
    order: 23,
    title: 'Креативна работа со мултимодална AI',
    subtitle: 'Комбинирање текст, слика и видео алатки за еден наставен материјал',
    description:
      'Оваа академија веќе ги наведува одделни визуелни и мултимедијални AI алатки (Canva Magic, DALL-E, Midjourney, Synthesia, Pika). Овој дел покажува како се комбинираат во еден работен тек за да се создаде целосен материјал, наместо да се користат изолирано.',
    keyPoints: [
      'Работен тек: текстуална AI (план/скрипта) → визуелна AI (илустрации/дијаграми) → мултимедијална AI (видео/анимација) — секој чекор го користи излезот од претходниот',
      'Пример: Gemini генерира објаснување на концепт → Canva Magic создава инфографик од клучните точки → Synthesia претвора истиот текст во кратко видео објаснување',
      'Задржете сопствена контрола врз идејата: AI комбинира и стилизира, но структурата и педагошката цел треба да бидат ваши, не резултат на тоа "што излезе"',
      'Не секој материјал бара сите три чекори — почнете со она што недостасува (обично: визуелна поддршка за апстрактен концепт)',
    ],
    icon: '🎨',
    competences: ['C2'],
  },
...
// ── EU-OECD AI Literacy Framework alignment (ailiteracyframework.org, 4 domains / 19 competences) ──

export type CompetenceDomain = 'E' | 'C' | 'M' | 'S';

export const COMPETENCE_DOMAINS: Record<CompetenceDomain, { label: string; labelEn: string; color: string }> = {
  E: { label: 'Ангажирање со AI', labelEn: 'Engage with AI', color: 'bg-sky-100 text-sky-700' },
  C: { label: 'Создавање со AI',  labelEn: 'Create with AI',  color: 'bg-emerald-100 text-emerald-700' },
  M: { label: 'Управување со AI', labelEn: 'Manage AI',       color: 'bg-amber-100 text-amber-700' },
  S: { label: 'Обликување на AI', labelEn: 'Shape AI',        color: 'bg-violet-100 text-violet-700' },
};

/** Short MK gloss for each of the 19 official competences, keyed by code. */
export const COMPETENCE_META: Record<string, string> = {
  E1: 'Препознавање на улогата и влијанието на AI во различни контексти',
  E2: 'Објаснување како AI системите извршуваат задачи, без погрешни концепции',
  E3: 'Проценка дали AI резултат треба да се прифати, поправи или отфрли',
  E4: 'Испитување како препорачувачките системи го обликуваат перспективата',
  E5: 'Споредба на потрошувачката на енергија и ресурси на AI системите',
  E6: 'Објаснување како AI може да ги засили општествените пристрасности',
  E7: 'Анализа на усогласеност со етички принципи и човечки вредности',
  C1: 'Употреба на AI за истражување нови перспективи врз основа на оригинални идеи',
  C2: 'Визуелизирање, прототипирање и комбинирање идеи со различни AI системи',
  C3: 'Насочување на генеративен AI за повратни информации и рефлексија',
  C4: 'Анализа како AI ја штити или ја нарушува автентичноста и интелектуалната сопственост',
  M1: 'Одлучување дали да се користи AI според природата на задачата',
  M2: 'Избор на соодветен AI пристап преку споредба на системи',
  M3: 'Разложување проблем за да се одреди кога и како да се користи AI',
  M4: 'Следење и оценување на употребата на AI низ процесот на решавање',
  S1: 'Испитување како еден AI систем е замислен да работи, за кого и со какви ограничувања',
  S2: 'Оценување AI системи со дефинирани критериуми, тест-случаи и повратни информации',
  S3: 'Дизајнирање AI системи со внимание на изворите и текот на податоците',
  S4: 'Подобрување на AI системи за човечка добросостојба и општествена корист',
};
