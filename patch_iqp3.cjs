...
const regex = /<div className="flex flex-col flex-1 min-w-\[120px\]">\s*<span className="text-\[10px\] font-black text-gray-400 uppercase tracking-widest">([^<]*)<\/span>\s*<h2 className="text-sm font-bold text-gray-700 line-clamp-1">\{quizTitle\}<\/h2>\s*<\/div>/;

const replacement = `<div className="flex flex-col flex-1 min-w-[120px] gap-1">
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">$1</span>
