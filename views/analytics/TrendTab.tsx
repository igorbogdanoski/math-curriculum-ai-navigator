                    ...
                    {weeklyTrend.map((w, i) => {
                        ...
                        return (
                            <div key={w.label} className="flex items-center gap-3">
                                <span className="text-xs text-gray-500 w-16 flex-shrink-0">{w.label}</span>
                                ...
                                <span className="text-xs text-gray-500 w-16 flex-shrink-0">{w.count} обид{w.count === 1 ? '' : 'и'}</span>
                            </div>
                        );
                    })}
