...
- solution: ЗАДОЛЖИТЕЛНО за type='task' и type='example' — низа на чекори/линии кои го покажуваат целосното решение; за останатите типови НЕ вклучувај го ова поле
...
- За 'task': content[] = задача; solution[] = детално решение чекор по чекор
- За 'example': content[] = поставување; solution[] = изработка на примерот
