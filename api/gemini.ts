...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  else if (modelName.includes('thinking')) modelName = 'gemini-2.0-flash-thinking-exp-01-21'; // Most stable thinking model
  else if (modelName.includes('pro') && !modelName.includes('1.5')) modelName = 'gemini-2.0-pro-exp-02-05'; // High reasoning model
